...
training model and results edition
"""
import logging
import joblib
import pandas as pd
...
from helpers import plot_and_save, generate_img_name, generate_report, calculate_feature_importances
from constants import DATA_PATH, IMG_PATH, MODEL_PATH, LOG_PATH, cat_columns, keep_cols, random_seed
...
def train_models(X_train, X_test, y_train, y_test):
    ...
    fig = RocCurveDisplay (lrc, X_test, y_test)
    fig = RocCurveDisplay (
